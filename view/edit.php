...
<div class="container">
        <div class="row justify-content-center">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <a class="btn btn-link" href="../control/rpp.php">Remove Profile Picture</a>
            ...
            <form action="../control/redirect.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-link" href="portal.php">Cancel</a>
            </div>
        </form>
